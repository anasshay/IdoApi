...
namespace IdoApi.Controllers
{
    ...
    public class ImportancesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutImportanceModel(int id, ImportanceModel importanceModel)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<ImportanceModel>> PostImportanceModel(ImportanceModel importanceModel)
        {
          if (_context.ImportanceModel == null)
          {
